...
// Opcioneshombre ahora recibe la prop 'productos'
const Opcioneshombre = ({ menu, productos }) => {
  return (
    <div className="p-6">
      <button 
        onClick={menu} 
      ...
      <h2 className="text-4xl font-extrabold text-gray-900 text-center mb-10">Moda para Hombre</h2>
